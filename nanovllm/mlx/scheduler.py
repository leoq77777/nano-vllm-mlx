"""Continuous batching scheduler for MLX (ported from ``engine/scheduler.py``)."""

from __future__ import annotations

from collections import deque

from nanovllm.mlx.block_manager import BlockManager
...
class MLXScheduler:
    def __init__(self, config: MLXConfig):
        ...
        self.eos = config.eos
        self.block_manager = BlockManager(config.resolve_num_kv_cache_blocks(), config.kvcache_block_size)
